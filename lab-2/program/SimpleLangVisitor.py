...
class SimpleLangVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by SimpleLangParser#ModPow.
    def visitModPow(self, ctx:SimpleLangParser.ModPowContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by SimpleLangParser#Compare.
